...
public class AndGate2 extends AppCompatActivity {
    private Switch s1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_and_gate2);

        s1  = findViewById(R.id.and2switch1);
        im2 = findViewById(R.id.and2imageView2);
        im6 = findViewById(R.id.and2imageView6);
        tb1 = findViewById(R.id.and2toggleButton);
        tb2 = findViewById(R.id.and2toggleButton2);
        tx1 = findViewById(R.id.and2textView8);
...
//                        im2.setVisibility(View.VISIBLE);
            ...
            s1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (s1.isChecked()) {
                        Toast.makeText(AndGate2.this, "Login To use Interactive mode", Toast.LENGTH_SHORT).show();
//                        im2.setEnabled(true);
//                        im2.setVisibility(View.VISIBLE);
                        im6.setVisibility(View.GONE);
                        tb1.setVisibility(View.GONE);
