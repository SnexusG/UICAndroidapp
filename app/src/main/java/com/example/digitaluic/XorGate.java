...
public class XorGate extends AppCompatActivity {
    private Switch s1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1  = findViewById(R.id.xorswitch1);
        im2 = findViewById(R.id.xorimageView2);
        im6 = findViewById(R.id.xorimageView6);
        tb1 = findViewById(R.id.xortoggleButton);
        tb2 = findViewById(R.id.xortoggleButton2);
        tx1 = findViewById(R.id.xortextView8);
...
//                        im2.setVisibility(View.VISIBLE);
            ...
            s1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (s1.isChecked()) {
                        Toast.makeText(XorGate.this, "Login To use Interactive mode", Toast.LENGTH_SHORT).show();
//                        im2.setEnabled(true);
//                        im2.setVisibility(View.VISIBLE);
                        im6.setVisibility(View.GONE);
                        tb1.setVisibility(View.GONE);
