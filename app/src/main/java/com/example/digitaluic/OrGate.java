...
public class OrGate extends AppCompatActivity {
    private Switch s1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_or_gate);

        s1  = findViewById(R.id.orswitch1);
        im2 = findViewById(R.id.orimageView2);
        im6 = findViewById(R.id.orimageView6);
        tb1 = findViewById(R.id.ortoggleButton);
        tb2 = findViewById(R.id.ortoggleButton2);
        tx1 = findViewById(R.id.ortextView8);
...
//                        im2.setVisibility(View.VISIBLE);
            ...
            s1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (s1.isChecked()) {
                        Toast.makeText(OrGate.this, "Login To use Interactive mode", Toast.LENGTH_SHORT).show();
//                        im2.setEnabled(true);
//                        im2.setVisibility(View.VISIBLE);
                        im6.setVisibility(View.GONE);
                        tb1.setVisibility(View.GONE);
