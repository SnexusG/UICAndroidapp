...
public class NandGate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1  =  findViewById(R.id.nandswitch1);
        im2 =  findViewById(R.id.nandimageView2);
        im6 =  findViewById(R.id.nandimageView6);
        tb1 =  findViewById(R.id.nandtoggleButton);
        tb2 =  findViewById(R.id.nandtoggleButton2);
        tx1 =  findViewById(R.id.nandtextView8);
...
//                        im2.setVisibility(View.VISIBLE);
            ...
            s1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (s1.isChecked()) {
                        Toast.makeText(NandGate.this, "Login To use Interactive mode", Toast.LENGTH_SHORT).show();
//                        im2.setEnabled(true);
//                        im2.setVisibility(View.VISIBLE);
                        im6.setVisibility(View.GONE);
                        tb1.setVisibility(View.GONE);
